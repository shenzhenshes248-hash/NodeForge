...
if __name__ == '__main__':
    sys.exit(main())
NODEFORGE_VERIFIER
    local version='v0.4.0' asset base source file
    ...
    for file in VERSION nodeforge.sh templates/vless-reality.json templates/nodeforge-xray.service templates/nodeforge-hysteria.service lib/common.sh lib/defaults.sh lib/version.sh lib/state.sh lib/system.sh lib/xray.sh lib/hysteria.sh lib/reality.sh lib/config.sh lib/service.sh lib/transaction.sh lib/share.sh lib/runtime.sh lib/update.sh lib/update.py lib/cli.sh lib/network.py lib/management.py tools/release.py trust/release-ed25519.pub lib/argo.sh lib/argo_runtime.py templates/vless-ws.json templates/nodeforge-argo.service templates/nodeforge-argo-xray.service lib/subscription.sh lib/subscription.py templates/nodeforge-subscription.service install.sh uninstall.sh LICENSE README.md docs/M2_PHASE3.md; do
