...
if __name__ == '__main__':
    sys.exit(main())
NODEFORGE_VERIFIER
    local version='v0.2.0-dev' asset base source file
    ...
    for file in VERSION nodeforge.sh templates/vless-reality.json templates/nodeforge-xray.service lib/common.sh lib/defaults.sh lib/version.sh lib/state.sh lib/system.sh lib/xray.sh lib/reality.sh lib/config.sh lib/service.sh lib/transaction.sh lib/share.sh lib/runtime.sh lib/cli.sh lib/network.py lib/management.py install.sh uninstall.sh LICENSE README.md tools/release.py docs/M2_PHASE3.md trust/release-ed25519.pub; do
