...
**当前：Phase 2 COMPLETE，含 dual-stack 实机修复，基线 `e22e9016801e3931e53dbd83019929625ca2fa88`。Phase 3 本地 Release Bundle + Signed Manifest 已实现，尚未提交，等待审核；VERSION 仍为 `v0.2.0-dev`。用法与范围见 [M2_PHASE3.md](M2_PHASE3.md)。本轮没有 VPS、bootstrap 或 update 操作。下文为历史记录。**
