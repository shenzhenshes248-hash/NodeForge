...
**M1 COMPLETE；M2 COMPLETE。正式版本 v0.2.0，VERSION 为唯一版本来源。**
...
官方仓库：https://github.com/shenzhenshes248-hash/NodeForge；主分支 master；正式 annotated tag：v0.2.0。Release assets：manifest.json、manifest.sig、nodeforge-v0.2.0.tar.gz。固定 Ed25519 公钥位于 trust/release-ed25519.pub，私钥保存在仓库之外，不提交或打包。
